...
namespace WebSite.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static void AddCount(string strTable, string strField, string strWhere, int num)
        {
            string strSql = "update " + strTable + " set " + strField + "=" + strField + "+" + num + " where " + strWhere + "";
